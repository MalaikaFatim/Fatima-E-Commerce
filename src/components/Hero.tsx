...
function Hero() {
  ...
  return (
    <div className="relative w-full bg-pink-50 overflow-hidden flex flex-col md:flex-row items-center justify-between">
